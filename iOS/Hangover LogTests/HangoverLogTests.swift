import XCTest
@testable import HangoverLog

@MainActor
final class HangoverLogTests: XCTestCase {
    ...
    func testUpdateReplacesItem() {
        ...
        first.drinksConsumed = "Updated Name"
        store.update(first)
        XCTAssertEqual(store.items.first?.drinksConsumed, "Updated Name")
    }
