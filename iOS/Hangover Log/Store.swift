...
final class Store: ObservableObject {
    ...
    init() {
        ...
        fileURL = support.appendingPathComponent("hangoverlog_items.json")
        load()
    }
    ...
    private func seedData() -> [EntryItem] {
        [
        EntryItem(drinksConsumed: "4", symptom: "Headache", severity: "3", notes: "Should have had more water."),
        EntryItem(drinksConsumed: "2", symptom: "Fatigue", severity: "2", notes: "Not bad, stopped early.")
        ]
    }
}
