                        ...
                        ForEach(store.items) { item in
                            Button {
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    Text(item.drinksConsumed.isEmpty ? "Untitled" : item.drinksConsumed)
                                        .font(Theme.bodyFont.weight(.semibold))
                                        .foregroundStyle(Theme.ink)
                                    if !item.symptom.isEmpty {
                                        Text(item.symptom)
                                            .font(.caption)
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                TextField("DrinksConsumed", text: $draft.drinksConsumed)
                    .accessibilityIdentifier("field_drinksConsumed")
